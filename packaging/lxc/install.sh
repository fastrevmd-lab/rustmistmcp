...
printf '%s\n' 'Next: configure the live Mist profile/credentials, mint a supported token when mecmcp#160 is resolved, configure journal forwarding, then enable and start rustmistmcp.'
